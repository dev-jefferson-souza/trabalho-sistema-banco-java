		...
		while (true) {
			...
			if (linha != null) {
				...
				if (lerLinha [0].equalsIgnoreCase("Poupanca")) {
					Conta poupanca = new ContaPoupanca (Integer.parseInt(lerLinha[1]), Integer.parseInt(lerLinha[2]), Double.parseDouble(lerLinha[3]), lerLinha[4], lerLinha[5], lerLinha[6]);
					MapConta.getMapaConta().put(lerLinha[5], poupanca);
				} else if (lerLinha [0].equalsIgnoreCase("Corrente")); {
					Conta corrente = new ContaCorrente (Integer.parseInt(lerLinha[1]), Integer.parseInt(lerLinha[2]), Double.parseDouble(lerLinha[3]), lerLinha[4], lerLinha[5], lerLinha[6]);
